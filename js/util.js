...
const RANKING_JOGOS = {
  ...
  pingueVitorias: { nome: "Pingue-Pongue", rotulo: "vitórias" },
  quebrablocos: { nome: "Quebra-Blocos", rotulo: "pontos" },
  corredor: { nome: "Corredor", rotulo: "metros" },
  coletar: { nome: "Coletar", rotulo: "pontos" },
  piano: { nome: "Piano", rotulo: "teclas" },
  atravessar: { nome: "Atravessar", rotulo: "travessias" },
  basquete: { nome: "Basquete", rotulo: "cestas" },
  hanoiNivel: { nome: "Torre de Hanói", rotulo: "discos" },
